...
const ITEMS_MENU: ItemMenu[] = [
  ...
  { ruta: '/asistencia-personal', etiqueta: 'Asistencia Personal', icono: 'badge', nivelMinimo: 3 },
  { ruta: '/ingreso-personal', etiqueta: 'Lista Personal', icono: 'person_add', nivelMinimo: 3 },
