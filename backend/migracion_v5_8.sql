-- ============================================================
-- MIGRACIÓN BASE DE DATOS v5.8 — Sistema Hosanna Infantil
-- Extensión de estados de liderazgo y propagación de datos
-- ============================================================
...
-- Agregar Líder Apoyo a los estados de liderazgo
ALTER TYPE estado_liderazgo ADD VALUE IF NOT EXISTS 'Lider_Apoyo';

-- Redefinir la función de propagación para incluir Estado_Liderazgo y mapearlo a Estado_Operativo
...
BEGIN
    IF NEW.Estado = 'Aprobado' AND OLD.Estado = 'Pendiente' THEN
        ...
        -- Personal_Info_Iglesia (Propaga Estado_Liderazgo y calcula Estado_Operativo)
